const pitems = [
    {
      ...
      },
      {
        ...
        "fullDescription": "Depthify is a Python package that utilizes Nvidia GPU technology to generate depth maps and parallax animations. This tool transforms static images into captivating motion pictures, adding a layer of depth and movement that enhances visual storytelling.",
      },
      {
        "title": "Tkinter Windows Application",
        "shortDescription": "Automation tool with bot detection avoidance.",
